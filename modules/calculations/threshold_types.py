...
Key types:
- TransitionZone: Range-based threshold with confidence (PREFERRED)
- TestValidityReport: Validation result for ramp test data quality
- EnhancedThresholdResult: Full threshold info with confidence breakdown
"""
