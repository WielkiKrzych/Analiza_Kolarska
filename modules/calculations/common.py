...
CARB_FRACTION_BELOW_VT1 = 0.30  # Research: ~25-35% CHO below VT1 (was 0.40)
CARB_FRACTION_VT1_VT2 = 0.70  # Research: ~60-75% CHO between thresholds (was 0.70)
CARB_FRACTION_ABOVE_VT2 = 0.90  # Research: ~85-95% CHO above VT2 (was 1.00)
DFA_ALPHA_MIN = 0.3
DFA_ALPHA_MAX = 1.5
MIN_WATTS_ACTIVE = 50
MIN_HR_ACTIVE = 90
